...
@section('body')
    ...
    <div class="col-md-12">{{Field::input('text','NameTemplates')}}</div>
    <div class="col-md-12">{{Field::input('text','TypeDocuments',null,['readonly', 'id' => 'byTypeDocuments', 'data-toggle' => "modal", 'data-target' => "#myModalTypeDocuments"])}}</div>
    @include('report.template.byTypeDocuments')
