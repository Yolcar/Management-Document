...
@section('body')
    ...
    <div class="col-md-12">{{Field::input('text','NameUser')}}</div>
    <div class="col-md-12">{{Field::input('text','Cedula')}}</div>
    <div class="col-md-12">{{Field::input('text','Email')}}</div>
    <div class="col-md-12">{{Field::input('text','Groups',null,['readonly', 'id' => 'byGroups', 'data-toggle' => "modal", 'data-target' => "#myModalGroups"])}}</div>
    @include('report.user.byGroups')
